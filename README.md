...
- 짧은 프로젝트 기간으로 메인 페이지, 상품 상세 페이지, 회원가입 및 로그인 부분 구현 완료
...
위 기준을 가지고 프로젝트를 선정하였고, 마플샵을 한 첫번째 이유는 웹개발의 정석은 이커머스라고 생각해서 입니다. BTC구조를 가진 서비스들이 날로 성장하고있고 앞으로도 성장가능성이 크며 그 시장 역시 무궁무진하다고 느꼈기 때문입니다.
